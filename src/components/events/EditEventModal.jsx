...
import { Calendar, Clock, MapPin, Users, Bell, Edit } from "lucide-react";

export default function EditEventModal({ isOpen, onClose, event, onSubmit, employees }) {
  ...
  useEffect(() => {
    if (event && isOpen) {
      setFormData({
        ...
        department_filter: event.department_filter || "",
        target_employee_id: event.target_employee_id || "",
        priority: event.priority || "normal",
        is_recurring: event.is_recurring || false,
        recurrence_type: event.recurrence_type || "yearly",
